...
- `model_list`: List of models. Each model needs to include `model_name` and `model_description` keys.
- `router_prompt`: Prompt for the routing model. If None, uses the default prompt.
